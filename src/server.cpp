...
bool first_service_callback(first_pkg::first_srv::Request &req, first_pkg::first_srv::Response &res)
{
    ...
    ROS_INFO("From Server [%s] , Client says [%s]", res.out.c_str(), req.in.c_str());
    return true;
}
...
first_pkg::fist_srv::Request
and sends the response in the
first_pkg::fist_srv::Response type*/
